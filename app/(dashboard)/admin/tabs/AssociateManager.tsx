...
import {
  ...
  ChevronRight, Eye, RefreshCw, KeyRound, Copy,
} from 'lucide-react'
...
export function AssociateManager() {
  ...
  const db = supabase as any // associates table not in generated types yet
                ...
                {(selected.aadhar_doc_url || selected.pan_doc_url || selected.cheque_doc_url) && (
                  <>
                    ...
                    {selected.aadhar_doc_url && (
                      <DocLink label="Aadhaar Card" url={selected.aadhar_doc_url} />
                    )}
                    {selected.pan_doc_url && (
                      <DocLink label="PAN Card" url={selected.pan_doc_url} />
                    )}
                    {selected.cheque_doc_url && (
                      <DocLink label="Cancelled Cheque" url={selected.cheque_doc_url} />
                    )}
                  </>
                )}
